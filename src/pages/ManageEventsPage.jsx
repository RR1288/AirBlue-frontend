                ...
                <section className={styles.eventsSection}>
                    {loading ? (
                        ...
                        filteredEvents.map((event) => {
                            const hasBudget = Number(event.eventBudget) !== 0;
                            const hasGroups =
                                event.EventGroups && event.EventGroups.length > 0;
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className={styles.eventAttendees}>
                                        Expected Attendees:{" "}
                                        {event.expectedAttendees} | Max
                                        Attendees: {event.maxAttendees}
                                    </p>
                                    <div className={styles.options}>
                                        {!hasBudget ? (
                                            // When no budget is setup, only allow Edit and Delete
                                            <span
                                                className={
                                                    styles.warningChip
                                                }
                                            ...
                                            // When budget is set but no groups exist:
                                            <>
                                                <button
                                                    className={
                                                        styles.optionButton
                                            ...
                                            // When budget is set and groups exist:
                                            <>
                                                <button
                                                    className={
                                                        styles.optionButton
