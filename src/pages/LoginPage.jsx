        ...
        <div className={styles.page}>
            ...
            <div className={styles.mainContent}>
                ...
                <div className={styles.loginContainer}>
                    ...
                    <button onClick={() => navigate('/attendee-register')} className={styles.buttonSecondary}>
                        Register as Attendee
                    </button>
                </div>
            </div>

            <PinModal isOpen={showPinModal} onSubmit={handlePinSubmit} onClose={() => setShowPinModal(false)} />
        </div>
    );
};
